...
<body>
  ...
  <table class="kytenwrap" style="margin-top: 40px;">
    <tr>
      <td class="kyten"><b>NGƯỜI GIAO CA</b><br/>(Ký, ghi rõ họ tên)<br/><br/><br/><br/>${escapeHtml(bg.nguoiGiao || "")}</td>
      <td class="kyten"><b>NGƯỜI NHẬN CA</b><br/>(Ký, ghi rõ họ tên)<br/><br/><br/><br/></td>
    </tr>
  </table>
</body>
</html>`;
