...
import { Plus, X, ChevronLeft, ChevronRight, AlertTriangle, Users, ClipboardList, ArrowRightLeft, Wrench, Package, FolderOpen, Search, Activity, Home, LogOut, Zap } from "lucide-react";
...
export default function QuanLyNhaMay() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900" style={{ fontFamily: "'IBM Plex Sans', system-ui, sans-serif" }}>
      {/* Header */}
      <header className="bg-gradient-to-r from-blue-950 via-blue-900 to-cyan-800 px-4 sm:px-8 py-3 sticky top-0 z-20 shadow-lg">
